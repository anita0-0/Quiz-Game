...
<head>
  ...
  <title>Travel Quiz - Hard Level</title>
  <style>
    ...
    body {
      ...
      text-align: center;
      padding: 20px;
      background-image: url('travelmedium1.jpg');
      height: 100vh;
...
<body>
  ...
  <script>
const apiUrl = 'https://opentdb.com/api.php?amount=10&category=22&difficulty=hard&type=multiple';
let questions = [];
